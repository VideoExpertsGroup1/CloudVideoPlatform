...
public class CmdSetCamAudioConf implements CmdHandler {
    public static final String TAG = CmdSetCamAudioConf.class.getSimpleName();
    @Override
    public String cmd() {
        return CameraManagerCommandNames.SET_CAM_AUDIO_CONF;
    }
