...
public class CmdGetAudioDetection implements CmdHandler {
    public static final String TAG = CmdGetAudioDetection.class.getSimpleName();

    @Override
    public String cmd() {
        return CameraManagerCommandNames.GET_AUDIO_DETECTION;
    }
