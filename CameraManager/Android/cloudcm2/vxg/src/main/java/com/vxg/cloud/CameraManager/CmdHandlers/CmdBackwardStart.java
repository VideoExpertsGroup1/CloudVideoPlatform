...
public class CmdBackwardStart implements CmdHandler {
    public static final String TAG = CmdBackwardStart.class.getSimpleName();

    @Override
    public String cmd() {
        return CameraManagerCommandNames.BACKWARD_START;
    }
