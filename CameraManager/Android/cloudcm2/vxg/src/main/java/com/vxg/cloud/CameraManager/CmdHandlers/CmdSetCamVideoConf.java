...
public class CmdSetCamVideoConf implements CmdHandler {
    public static final String TAG = CmdSetCamVideoConf.class.getSimpleName();
    @Override
    public String cmd() {
        return CameraManagerCommandNames.SET_CAM_VIDEO_CONF;
    }
