...
public class CmdSetStreamConfig implements CmdHandler {
    public static final String TAG = CmdSetStreamConfig.class.getSimpleName();
    ...
    public void handle(JSONObject request, CameraManagerClientListener client) {
        ...
        try {
            ...
            StreamConfig streamConfig = new StreamConfig(request);
            client.getConfig().setStreamConfig(streamConfig);
