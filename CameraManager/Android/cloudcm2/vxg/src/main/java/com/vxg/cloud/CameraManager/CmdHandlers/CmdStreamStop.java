...
public class CmdStreamStop implements CmdHandler {
    public static final String TAG = CmdStreamStop.class.getSimpleName();

    @Override
    public String cmd() {
        return CameraManagerCommandNames.STREAM_STOP;
    }
