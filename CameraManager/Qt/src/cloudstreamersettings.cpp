...
CloudStreamerSettings::CloudStreamerSettings(QString sFilename, QString sFilenameSession){
	...
	m_bEventsConf_memorycard_isenabled = false;
	...
	if(QFile::exists(m_sFilename)){
		...
		m_bEventsConf_memorycard_isenabled = readBooleanFromSettings(sett, "EVENTSCONF/memorycard_isenabled", false);
...
void CloudStreamerSettings::saveSessionIni(){
	...
	sett.setValue("EVENTSCONF/memorycard_isenabled", m_bEventsConf_memorycard_isenabled);
...
bool CloudStreamerSettings::eventsconf_memorycard_isenabled(){
	return m_bEventsConf_memorycard_isenabled;
};
